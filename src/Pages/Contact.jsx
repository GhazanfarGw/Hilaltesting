        ...
        <div className=''>
            ...
            <div className='max-w-screen-xl overflow-hidden items-center justify-center mx-auto'>
                <div className='md:pt-52 md:px-10 px-5 pt-28'>
                    ...
                    <div className='md:mt-16 mt-10 border-l-4 border-l-[#16A48E] max-w-screen-lg'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='mx-auto'>
                    <div className='md:grid md:grid-cols-2 gap-8'>
                        <input
                            className='bg-[] border border-[#16A48E] border-opacity-30 py-2 w-full px-4 mx-auto'
                        ...
                        />
                        <input
                            className='bg-[] border border-[#16A48E] border-opacity-30 py-2 w-full px-4 mx-auto mt-8 md:mt-0'
                    ...
                    <input
                        className='bg-[] border border-[#16A48E] border-opacity-30 py-2 w-full px-4 mx-auto mt-8'
                        placeholder='Subject'
                        type="subject"
                        id="subject"
                        value={subject}
                    ...
                    />
                    <textarea
                        className='bg-[] border border-[#16A48E] border-opacity-30 pb-52 py-5 w-full px-4 mx-auto mt-8 overflow-y-hidden'
                        placeholder='Message'
                        type="message"
                        id="message"
                        value={message}
                    ...
                    <div className='items-center'>
                        <button className='bg-[#16A48E] px-10 tracking-wider py-2 md:mt-10 mt-5 text-black' type="submit">
                            {loading ? 'Loading...' : 'Submit'}
                        </button>
                    </div>
                </div>}
                {success && <p className='justify-center mx-auto text-center pt-10 font-semibold text-[#16A48E]'>Email sent successfully!</p>}
            </form>
        </div>
        <Footer/>
    </>
